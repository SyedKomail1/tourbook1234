...
const RegisterScreen = ({ navigation }) => {
  ...
  const addData = async (e) => {
    ...
    axios
      .post("https://tourbook-backend.herokuapp.com/user/signup",{
      email: inputs.email,
  ...
  return (
    ...
    <StatusBar translucent={false} backgroundColor={COLORS.primary} />
      ...
      <View style={style.upView}>
          <Image style ={{resizeMode: 'contain', height: '250%',  marginTop:20,  }}  source={require("../../assets/travel1-01.png")} /> 
        </View>
...
<Text
            ...
            <View style={{ flex: 1,backgroundColor:'white',marginLeft:7,paddingTop:3,height:60, borderBottom: '1px solid'}}>
              <Picker
               label="hello"
      ...
      <View style={{  flex: 1, flexDirection:'row', marginRight:20,justifyContent:'center', alignItems: 'center',}} >
